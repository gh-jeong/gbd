...
cdef class Complex128HashTable(HashTable):
    ...
    @cython.boundscheck(False)
    def map(self, const complex128_t[:] keys, const int64_t[:] values):
        cdef:
    ...
    @cython.boundscheck(False)
    def map_locations(self, const complex128_t[:] values):
        cdef:
            Py_ssize_t i, n = len(values)
            int ret = 0
            khcomplex128_t val
    ...
    @cython.boundscheck(False)
    def lookup(self, const complex128_t[:] values):
        cdef:
            Py_ssize_t i, n = len(values)
            int ret = 0
            khcomplex128_t val
...
cdef class Complex64HashTable(HashTable):
    ...
    @cython.boundscheck(False)
    def map(self, const complex64_t[:] keys, const int64_t[:] values):
        cdef:
            Py_ssize_t i, n = len(values)
            int ret = 0
            khcomplex64_t key
    ...
    @cython.boundscheck(False)
    def map_locations(self, const complex64_t[:] values):
        cdef:
            Py_ssize_t i, n = len(values)
            int ret = 0
            khcomplex64_t val
    ...
    @cython.boundscheck(False)
    def lookup(self, const complex64_t[:] values):
        cdef:
            Py_ssize_t i, n = len(values)
            int ret = 0
            khcomplex64_t val
