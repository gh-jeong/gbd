...
def table_1(data, cause, measure, risk=None): #todo Table 1
    ...
    if not risk:
        ...
        for cause in cause:
            for measure in measure
                value_t = gbd_retrieve(data, meausre, location_name="Global", age=22, metric=1, year=2019) #todo: add 'risk' variable in gbd_retrieve function
                df[cause, measure] = value_t 